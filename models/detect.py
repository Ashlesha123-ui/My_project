...
class PipeCount(models.Model):
    ...
    # @torch.no_grad()
    def get_pipe_count(self,weights='yolov5s.pt',  # model.pt path(s)
        ...
        # Initialize
        weights="/odoo/Pipex/pipi_count/static/src/pt/pipe_in_pipe_yolov5s.pt"
        set_logging()
        ...
        for path, img, im0s, vid_cap in dataset:
            ...
            if pt:
                ...
                print("predpredpredpredpredpredpredpredpredpredpredpredpred",type(pred),pred)
            elif onnx:
