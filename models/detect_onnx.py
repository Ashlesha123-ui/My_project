...
def run(
    ...
    max_det=5000,  # maximum detections per image
    ...
    project="/odoo/Pipex/pipi_count/static/src/img",  # save results to project/name
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        t2 = time_sync()
        #print("predJGGGGGGGGGGGGGGGGGGGGGGGGG:",pred)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            annotator = Annotator(im0, line_width=line_thickness, pil=True)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        ##print("label: ",label)
                        cord, rrrr, img_d = annotator.box_label(
                            xyxy, templates, label, color=colors(c, True)
                        )
            ...
            im0 = im0 if isinstance(im0, Image.Image) else Image.fromarray(im0)
            pipe_len_text = "counts:" + str(int(n))
            fnt = ImageFont.truetype(
